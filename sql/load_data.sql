...
insert into Rest (restname, picurl, resttag,description, rating, address, city,state,country)
values ("Sava's","http://bigpanlittlepan.com/wp-content/uploads/2015/05/45-percent-sava-header-logo.png","Local restaurant","A local sanctuary where community, culture, and craft meet for a truly authentic culinary experience.","4.5","216 SOUTH STATE STREET ANN ARBOR, MI 88104","ann arbor","michigan","united state");

insert into Rest (restname, picurl, resttag,description, rating, address, city,state,country)
values ("Lucky Kitchen", "http://www.luckykitchen.net/images/index2_03.gif","authentic chinese food","Lucky Kitchen Chinese Restaurant, Ann Arbor, MI - LKfit Meals, takeout, dine-in and delivery from two locations near U of M. Authentic Chinese off-premise catering from appetizers to full meals is the healthy, economical way to feed any group.","3","611 E University Ave, Ann Arbor, MI 48104","ann arbor","michigan","united state");

insert into Rest (restname, picurl, resttag,description, rating, address, city,state,country)
values ("Evergreen","http://nebula.wsimg.com/01789fb1d98ed85afb8dae5da57d1648?AccessKeyId=49806A5A056E8BC7E822&disposition=0&alloworigin=1","Authentic Chinese Food","Since 1992, we have consistently served Ann Arbor with delicious, gourmet Chinese cuisine.  Specializing in Mandarin, Sizchuan, Hunan, Shanghai and Taiwan styles of cooking, Evergreen promises only the most authentic flavors with the freshest ingredients, and always at a affordable price.","5","2771 Plymouth Rd. Ann Arbor MI 48105 US","ann arbor","michigan","united state");


insert into Rest (restname, picurl, resttag,description, rating, address, city,state,country)
values ("The Upper West","http://www.theupperwest.com/wp-content/uploads/2014/05/250x54b.png","American Cuisine","With a constantly changing menu, Upper West boasts of Chef Nick Shipp’s eclectic individualistic dishes that tickle the palate with unique ingredients from all around the world. The restaurant reflects an uncompromising approach to modern American cuisine that knows no bounds coupled with exceptional customer service.","4.2","3321 Pico Blvd, Santa Monica, CA, 90404","Santa Monica","california","united state");

insert into Rest (restname, picurl, resttag,description, rating, address, city,state,country)
values ("Cha Cha Chicken","http://chachachicken.com/chachachicken7.jpg","caribbean cuisine","Caribbean cuisine with Latin fusion","2.0","1906 Ocean Ave,Santa Monica,CA, 90405","Santa Monica","california","united state");
...
insert into Review(rating, content,city,state,country)
values ("5","Orange chicken is the best","ann arbor","michigan","united state");
...
insert into Review(rating, content,city,state,country)
values ("1","The service is horrible","guangzhou","guangdong","china");

insert into ReviewContain(restid,revid,sequencenum)
values ("4","11","5");

insert into Review(rating, content,city,state,country)
values ("1","Everything taste the same lol","guangzhou","guangdong","china");
